'''
This file is adpted from https://github.com/lydiawunan/LOSTIN/blob/main/GNN-LSTM/dataset_pyg.py, with added node features.
'''
import sys
...
class PygGraphPropPredDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        if pd.isna(self.meta_info['additional node files']):
            additional_node_files = []
        else:
            additional_node_files = self.meta_info['additional node files'].split(',')
       
        if pd.isna(self.meta_info['additional edge files']):
...
if __name__ == '__main__':
    graph_dataset_path='../results/new_graph_dataset'
    pyg_dataset = PygGraphPropPredDataset(root = graph_dataset_path, name = 'vgraph')
