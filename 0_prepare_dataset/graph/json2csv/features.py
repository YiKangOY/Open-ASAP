...
def gen_dataset():
    ...
    read_dir='../results/new_graph_json/'
    dest_dir = '../results/new_graph_dataset/vgraph/raw/'

    os.makedirs(dest_dir, exist_ok=True)

    with open('../results/new_graph_dataset/vgraph/graph_info.csv', 'w') as f:
        writer = csv.writer(f)
    ...
    for i in range(len(vgraphs)):
        ...
        with open('../results/new_graph_dataset/vgraph/graph_info.csv', 'a') as f:
            writer = csv.writer(f)
    ...
    graph_label.to_csv(dest_dir+'graph-label.csv', index=False,)
